	...
	for i=1,numItems do
		...
		if(not locked and EasyLootSettings[GetLootMethod()] and
			(
				...
				or EasyLoot_InTable(EasyLootLootList.autoloot, lootName)
			)
		...
		if(not itemLooted and EasyLootSettings.quest and not(EasyLoot_InTable(EasyLootLootList.ignore, lootName))) then
			--DEFAULT_CHAT_FRAME:AddMessage("|cffffff00EasyLoot quest " .. i)
